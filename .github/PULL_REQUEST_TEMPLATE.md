...
- [ ] If this changes project structure, conventions, env vars, or the tool/prompt/resource surface: every layer of the documentation set that carries the rule is updated - `CLAUDE.md`, `.github/copilot-instructions.md`, and the detail in `architecture/` or `CONTRIBUTING.md` (see the MIRROR RULE at the top of `CLAUDE.md`)
