...
Their lifecycle, and reaching inside a running one for logs, execution, stats and files.
"""
...
def container_wait(
    ...
    Returns:
        dict: {"container", "until", "met", "timed_out", "status_code", "error", "health", "status", "matched_line",
