...
pin a version, replace `:latest` with a release tag (e.g. `:1.3.0`). To pull from Docker Hub instead,
swap the image for `gavinlucas/docker-mcp-server:latest` (or `docker.io/gavinlucas/docker-mcp-server`).
