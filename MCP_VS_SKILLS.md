...
|---|---|---|---|
| Full whack: everything enabled | 164 | 49,500 | 1,223 |
| Read-only, all domains | 76 | 20,726 | 927 |
...
**On an eager client that spread is 5,052 to 49,500 tokens, roughly 9.8x**, which makes trimming
...
That is a **2.5x** cut, with the router falling from 647 tokens to 315 as it stops advertising
...
5% of that configuration's 49,500-token floor. They do not shrink the way the tools do when you
...
|---|---|---|---|---|---|
| List containers (one-off) | 1,571 | **874** | 49,500 | 19,482 | 5,549 |
| Triage a crashed container | 2,732 | **2,035** | 49,500 | 19,482 | 7,812 |
| Bring up a Compose project | 2,666 | n/a¹ | 49,500 | n/a¹ | 6,489 |
...
- median 258 tokens, range 117-1,247 - so fetching the five tools a triage needs costs ~1,500 on
